      ...
      <Slider {...settings}>
        <div className="slide1">
          ...
          <div className="text-con-hero">
            ...
            <p>
              Boost your cow’s immunity, enhance milk yield, and protect against
              common infections with our veterinary-approved cow medicine range.
            </p>
            <Link to="/Product">
        ...
        <div className="slide1">
          ...
          <div className="text-con-hero">
            ...
            <p>
              Give your chicks the right start with balanced nutrition and
              disease resistance. Ideal for broilers and layers in their early
              growth phase.
            </p>
            <Link to="/Product">
        ...
        <div className="slide1">
          ...
          <div className="text-con-hero">
            ...
            <p>
              Treat stomach infections in poultry and livestock with fast-acting
              formulas that restore gut health and improve digestion.
            </p>
            <Link to="/Product">
